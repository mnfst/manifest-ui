# Contributing to Manifest UI

This guide explains how to set up and work with the Manifest UI project as a developer.
...
| Command                    | Description                                |
| -------------------------- | ------------------------------------------ |
| `pnpm run dev`             | Start dev server (registry on port 3001)   |
