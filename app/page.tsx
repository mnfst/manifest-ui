        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
            ...
            <div className="pt-4 flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://github.com/mnfst/manifest-ui/discussions/new?category=feature-request"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="max-w-2xl mx-auto space-y-16">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-4">
                <a
                  href="https://github.com/mnfst/manifest-ui/discussions"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://github.com/mnfst/manifest-ui/issues"
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-full border border-border bg-background/80 backdrop-blur-sm px-5 py-2 text-sm font-medium text-foreground hover:bg-background transition-colors"
                >
                ...
                <a
                  href="https://github.com/mnfst/manifest-ui"
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-full border border-border bg-background/80 backdrop-blur-sm px-5 py-2 text-sm font-medium text-foreground hover:bg-background transition-colors"
                >
